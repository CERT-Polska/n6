...
requirements = ['n6sdk==' + n6_version, 'n6lib==' + n6_version, 'intelmq', 'iptools==0.7.0']
...
setup(
    ...
    test_suite='n6datapipeline.tests',
    install_requires=requirements,
    entry_points={
        'console_scripts': console_scripts,
    },

    description='The data-processing-pipeline components of *n6*',
    ...
    keywords='n6 network incident exchange data pipeline',
)
