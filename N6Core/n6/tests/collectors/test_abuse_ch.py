...
class TestAbuseChRansomwareTrackerCollector(_TestAbuseChDownloadingTimeOrderedRowsCollectorBase):
    ...
    DEFAULT_ORIG_DATA = (
        ...
        '"2018-08-09 03:00:00", "ZZ5", "XX5", "5.5.5.5", '
        '"http://www.example_5.com", "offline", "", '
        '"5.5.5.5", "55555", "YY5"\n'
        '"2018-08-09 03:00:00", "ZZ4", "XX4", "4.4.4.4", '
        '"http://www.example_4.com", "offline", "", '
        '"4.4.4.4", "44444", "YY4"\n'
        '"2018-08-09 02:00:00", "ZZ3", "XX3", "3.3.3.3", '
        '"http://www.example_3.com", "offline", "", '
        '"3.3.3.3", "33333", "YY3"\n'
        '"2018-08-09 01:00:00", "ZZ2", "XX2", "2.2.2.2", '
        '"http://www.example_2.com", "offline", "", '
        '"2.2.2.2", "22222", "YY2"\n'
        '"2018-08-09 01:00:00", "ZZ1", "XX1", "1.1.1.1", '
        '"http://www.example_1.com", "offline", "", '
        '"1.1.1.1", "11111", "YY1"\n'
        '"2018-08-09 00:00:00", "ZZ0", "XX0", "0.0.0.0", '
        '"http://www.example_0.com", "offline", "", '
        '"0.0.0.0", "00000", "YY0"'
    )
    ...
    def cases(cls):
        yield param(
            ...
            orig_data=cls.DEFAULT_ORIG_DATA,
            expected_publish_output_calls=[
                call(
                    # routing_key
                    'abuse-ch.ransomware',
...
class TestAbuseChUrlhausUrlsCollector(_BaseCollectorTestCase):
    ...
    def cases(cls):
        yield param(
            ...
            url_info_pages=cls.DEFAULT_INFO_PAGES,
            expected_publish_output_calls=[
        ...
        yield param(
            ...
            expected_publish_output_calls=[
                call(
                    ...
                    # prop_kwargs
                    dict(cls.DEFAULT_PROP_KWARGS, headers={
                        'meta': {'http_last_modified': '2020-12-12 01:01:01'},
                    }),
                ),
            ],
            expected_saved_state={
