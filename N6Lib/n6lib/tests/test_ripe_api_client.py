    ...
    'data': {
        ...
        'records': [
            [
                ...
                {'details_link': None,
                 'key': 'export',
                 'value': 'to AS1299 announce AS11111111'},
                {'details_link': None,
                 'key': 'export',
...
DEFAULT_ASN__ABUSE_CONTACT_REQUEST = {
    ...
    'data': {
        ...
        'parameters': {'resource': '<ASN_OR_IP_NETWORK>'}  # irrevelant
    },
        ...
        'object': [
            {'attributes': {
                'attribute': [
                    ...
                    {'link': {'href': 'https://rest.db.ripe.net/ripe/role/ZXCV-EXMPL-RIPE',
                              'type': 'locator'},
                     'name': 'admin-c',
                    ...
                    {'link': {'href': 'https://rest.db.ripe.net/ripe/mntner/EXMP-CODE',
                              'type': 'locator'},
                     'name': 'mnt-by',
                    ...
                    {'comment': 'Filtered',
                     'name': 'source',
                     'value': 'RIPE'}]},
                'link': {'href': 'https://rest.db.ripe.net/ripe/role/ASDF-EXMPL-RIPE',
                         'type': 'locator'},
                'primary-key': {'attribute': [{'name': 'nic-hdl',
                                               'value': 'ASDF-EXMPL-RIPE'}]},
                'source': {'id': 'ripe'},
                'type': 'role'}
        ]
    },
    'terms-and-conditions': {'href': 'http://www.ripe.net/db/support/db-terms-conditions.pdf',
                          'type': 'locator'},
    'version': {'commit-id': '111a11a',
...
DEFAULT_ASN__ROLE_DETAILS_REQUEST_2 = {
        ...
        'object': [
            {'attributes': {
                'attribute': [
                    ...
                    {'name': 'address',
                     'value': 'GB'},
                    {'link': {'href': 'https://rest.db.ripe.net/ripe/person/SOME-PRSN-RIPE',
                              'type': 'locator'},
                     'name': 'admin-c',
    ...
    'terms-and-conditions': {
        ...
        'type': 'locator'},
    'version': {'commit-id': '1a1a1a1a1aaa',
                'timestamp': '2000-01-01T00:00:00Z',
                'version': '1.102.2'}
}

# Following default requests are None because two example urls
# has been created basing on the `person` pattern
# while we need the `role` pattern.
...
DEFAULT_ASN__PERSON_DETAILS_REQUEST_1 = {
            ...
            {'attributes':
                {'attribute': [
                    ...
                    {'comment': 'Filtered',
                     'name': 'source',
                     'value': 'RIPE'},
                    {'link': {'href': 'https://rest.db.ripe.net/ripe/xxxxx/MNT-Person_Example',
                              'type': 'locator'},
                     'name': 'mnt-by',
                     'referenced-type': 'mntner',
                     'value': 'MNT-Person_Example'}
                ]},
                'link': {'href': 'https://rest.db.ripe.net/ripe/person/XXXX_PERSON-RIPE',
                         'type': 'locator'},
                'primary-key': {'attribute': [{'name': 'nic-hdl',
                                               'value': 'XXXX_PERSON-RIPE'}]},
                'source': {'id': 'ripe'},
    ...
    'version': {'commit-id': '1a1a1a1aa',
                'timestamp': '2000-01-01T00:00:00Z',
                'version': '1.102.2'}
}

# It's None because example url#2 has been created basing on
# the `person` pattern while we need the `role` pattern.
        ...
        'object': [
            {'attributes': {
                'attribute': [
                    ...
                    {'name': 'phone',
                    'value': '+11 111 1111 1111'},
                    {'link': {'href': 'https://rest.db.ripe.net/ripe/role/BBBB-EXMPL-RIPE',
                              'type': 'locator'},
                     'name': 'admin-c',
                     'referenced-type': 'role',
                     'value': 'BBBB-EXMPL-RIPE'},
                    ...
                    {'comment': 'Filtered',
                     'name': 'source',
                     'value': 'RIPE'}]},
                'link': {'href': 'https://rest.db.ripe.net/ripe/role/AAAA-EXMPL-RIPE',
                         'type': 'locator'},
                'primary-key': {'attribute': [{'name': 'nic-hdl',
                                               'value': 'AAAA-EXMPL-RIPE'}]},
                'source': {'id': 'ripe'},
...
# It's None because example url#2 has been created
# basing on the `role` pattern while we need the `person` pattern.
