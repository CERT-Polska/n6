...
def main():
    ...
    try:
        ...
        for data in response:
            for key, val in data.viewitems():  #3
    ...
    test_legal_ok = True
    optional_params_keys = data_range.viewkeys() - constant_params.viewkeys()  #3 #3
    ...
    for _ in range(MAX_RETRY):
        ...
        try:
            ...
            for record in filtered_legal:
                ...
                for key, val in record.viewitems():  #3
    ...
    for key, val in illegal_params.viewitems():  #3
