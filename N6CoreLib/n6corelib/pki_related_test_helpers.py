...
class _LoadByCALabelAndSSLConfigLabelMixin(object):

    file_pattern = '{ssl_config_label}-{what}---{ca_label}.{ext}'

    @classmethod
    def get_params(cls, ca_label, ssl_config_label):
        # noinspection PyUnresolvedReferences
        params = super(_LoadByCALabelAndSSLConfigLabelMixin, cls).get_params(ca_label)
        params['ssl_config_label'] = ssl_config_label
        return params
...
class _load_ca_ssl_config_cnf_by_label_and_ca_label(_LoadByCALabelAndSSLConfigLabelMixin,
...
class _load_cert_metadata(_LoadByCALabelAndCertSerialMixin,
    ...
    >>> _load_cert_metadata('n6-service-ca', 'f9962d93676e439cdcb5') == {
    ...     'ca_label': 'n6-service-ca',
    ...     'cert_label': 'component','expires_on': dt(2027, 2, 27, 17, 13, 19),
    ...     'serial_number': 'f9962d93676e439cdcb5',
    ...     'subject_dict': {'cn': 'component-three',
    ...      'o': 'test.org',
    ...      'ou': 'n6components'},
    ...     'usage': 3,
    ...     'valid_from': dt(2018, 12, 11, 17, 13, 19)
    ... }
    True
    """
...
class _load_cert_metadata_by_label(_LoadByCertLabelMixin,
    ...
    """
    >>> from datetime import datetime as dt
    >>> _load_cert_metadata_by_label('component') == {
    ...     'ca_label': 'n6-service-ca',
    ...     'cert_label': 'component',
    ...     'expires_on': dt(2027, 2, 27, 17, 13, 19),
    ...     'serial_number': 'f9962d93676e439cdcb5',
    ...     'subject_dict': {'cn': 'component-three',
    ...      'o': 'test.org',
    ...      'ou': 'n6components'},
