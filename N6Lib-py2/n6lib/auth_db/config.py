...
class SQLAuthDBConfigMixin(ConfigMixin):
    ...
    def _install_session_variables_setter(self):
        session_variables = collections.OrderedDict(self.constant_session_variables)     #3: `collections.OrderedDict` -> `dict`
...
class SQLAuthDBConnector(SQLAuthDBConfigMixin):
    ...
    def __init__(self,
        ...
        self.context_deposit = ThreadLocalContextDeposit(
            repr_token=self.__class__.__name__,                                  #3: `__name__` -> `__qualname__`
